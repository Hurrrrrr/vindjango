...
class TastingNote:
    ...
    AROMA_POOL_RED = ("Smoke", "Barnyard", "Toast", "Cola", "Game", "Tobacco")
...
class ResultsLogic:
    ...
    OLD_WORLD = ("france", "italy", "spain", "germany", "greece", "portugal",
    "austria", "hungary", "russia", "ukraine", "moldova", "bulgaria",
    "serbia", "georgia", "switzerland", "croatia", "czechia", "turkey",
    "slovenia", "morocco", "united kingdom")
    NEW_WORLD = ("usa", "australia", "new zealand", "argentina", "chile",
    "south africa", "china", "israel", "japan", "uruguay", "canada")
    ...
    def create_results_tup(self, list_of_answer_result_bools, list_of_scores):
